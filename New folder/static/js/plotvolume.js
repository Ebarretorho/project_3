...
d3.json(url_data).then(data => {
    ...
    let layout = {
        title: "Yearly production volume per crop",
        xaxis: {
            title: 'Year'
          },
        yaxis: {
    ...
    Plotly.newPlot("plotvol", traceData, layout);
});  